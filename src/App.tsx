      ...
      <AnimatePresence mode="wait">
        ...
        {user && (
          ...
          >
            ...
            <aside className="hidden lg:flex flex-col w-64 bg-slate-900 text-slate-400 shrink-0 border-r border-slate-800">
              
              {/* Sidebar Header */}
              <div className="p-6 border-b border-slate-800 flex items-center gap-2 text-white">
                <div className="p-1.5 bg-emerald-500 rounded-xl text-slate-900 shadow-md">
                  <Sprout className="w-5 h-5" />
                </div>
                <span className="font-extrabold text-base tracking-tight">Agri<span className="text-emerald-400">Advisor</span></span>
              </div>
              ...
              <div className="p-4 border-t border-slate-800 flex items-center justify-between gap-2.5">
                ...
                >
                  ...
                  <div className="text-[10px] text-slate-500 font-semibold truncate">{user.email}</div>
                </button>
                <button
                  onClick={handleLogout}
                  className="p-2 bg-slate-800 hover:bg-red-950 hover:text-red-400 rounded-xl transition-colors shrink-0"
            ...
            <div className="flex-1 flex flex-col min-w-0">
              ...
              {/* Top bar header */}
              <header className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-100 p-4 flex justify-between items-center lg:px-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex items-center gap-1.5 lg:hidden">
                    ...
                    <span className="font-extrabold text-sm tracking-tight">AI Agri</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-4 ml-auto">
                  ...
                  {/* Sync Indicator */}
                  <div className="hidden sm:flex items-center gap-1.5 text-xs text-slate-400 font-bold bg-slate-50 px-3 py-1 rounded-full border border-slate-100">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className="relative p-2 rounded-xl bg-slate-50 hover:bg-slate-100/80 cursor-pointer border border-slate-100 text-slate-600 transition-colors focus:outline-none"
                    >
                      <BellRing className={`w-4 h-4 text-slate-600 ${notifications.filter(n => !n.isRead).length > 0 ? "animate-bounce text-amber-500" : ""}`} />
                    ...
                    {showNotifications && (
                      <>
                        ...
                        />
                        <div className="absolute right-0 mt-2.5 w-80 sm:w-96 bg-white rounded-3xl border border-slate-100 shadow-2xl z-50 overflow-hidden font-sans">
                          {/* Header */}
                          <div className="p-4 bg-slate-50 border-b border-slate-100 flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <Bell className="w-4 h-4 text-slate-600" />
                              <span className="font-extrabold text-xs text-slate-800 uppercase tracking-wider">Advisory Notifications</span>
                              {notifications.filter(n => !n.isRead).length > 0 && (
                              ...
                              notifications.map((n) => {
                                return (
                                  <div 
                                    ...
                                    className={`p-3.5 flex gap-3 items-start transition-colors cursor-pointer hover:bg-slate-50 relative ${!n.isRead ? "bg-blue-50/20" : ""}`}
                                  >
                                    {/* Icon selection */}
                                    ...
                                    <div className="min-w-0 flex-1">
                                      <div className="flex justify-between items-start gap-1">
                                        <h4 className={`text-xs font-bold leading-snug truncate ${!n.isRead ? "text-slate-900 font-extrabold" : "text-slate-700"}`}>
                                          {n.title}
                                        </h4>
                                    ...
                                    <div className="flex flex-col items-center gap-1.5 shrink-0 self-center">
                                      ...
                                      <button
                                        ...
                                        className="p-1 hover:bg-slate-100 text-slate-400 hover:text-red-500 rounded-lg transition-colors cursor-pointer"
              ...
              {mobileMenuOpen && (
                <div className="fixed inset-0 z-50 flex lg:hidden">
                  ...
                  <motion.div
                    ...
                    className="relative flex flex-col w-72 max-w-sm bg-slate-900 text-slate-400 h-full p-6 shadow-2xl"
                  >
                    <div className="flex justify-between items-center pb-6 border-b border-slate-800 text-white mb-6">
                      <div className="flex items-center gap-2">
                        <Sprout className="w-5 h-5 text-emerald-400" />
                        <span className="font-extrabold text-base">AgriAdvisor</span>
                      </div>
                      <button
                        onClick={() => setMobileMenuOpen(false)}
                    ...
                    <div className="pt-6 border-t border-slate-800 flex items-center justify-between gap-3 mt-auto text-white">
                      <button
                        onClick={() => {
